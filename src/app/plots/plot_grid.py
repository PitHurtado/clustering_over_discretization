...
class Plot_Grid:
    ...
    def __init__(self, grid_geo: gpd.GeoDataFrame, df: pd.DataFrame) -> None:
    ...
    def plot_density_customer(self, figsize=(10, 10)) -> None:
        ...
        logger.info(
            f"\n[Plotting Grid] Number of pixels with customers: {len(gdf_positive_density.index)} \n"
            f"[Plotting Grid] Number of pixels without customers: {len(gdf_zero_density.index)} \n"
        )
